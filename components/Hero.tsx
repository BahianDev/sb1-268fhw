      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
        ...
        >
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-green-900 dark:text-green-100 mb-6">
            Plant a Tree,{" "}
            <span className="text-green-600 dark:text-green-400">Mint an NFT</span>
          </h1>
          <p className="mt-6 text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Join the green revolution by planting real trees and receiving unique NFTs. 
            Each tree you plant helps combat climate change and becomes a digital collectible.
          </p>
